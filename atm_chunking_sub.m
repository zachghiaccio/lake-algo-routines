function[n_hist,hist_edges,elev_chunk,bound_range] = atm_chunking_sub(elev_bin, chunk)
...
% must input a number between 1-chunk_count (chunk_count = 9 right now)
%-------------------------------------------------------------------------%

chunk_window = floor(length(elev_bin)/9);
...
elev_chunk_sort = sort(elev_chunk);
